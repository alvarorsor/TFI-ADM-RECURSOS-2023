...
namespace TFI_ADM_RECURSOS_2023.Controllers
{
    public class ProyectosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,nombre,descripcion,fechaInicio,fechaEstimadaEntrega,fechaFinalizacion,ClienteId")] Proyecto proyecto)
        {
            ...
            ViewData["ClienteId"] = new SelectList(_context.Clientes, "Id", "CUIT", proyecto.ClienteId);
            return View(proyecto);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,nombre,descripcion,fechaInicio,fechaEstimadaEntrega,fechaFinalizacion,ClienteId")] Proyecto proyecto)
        {
            if (id != proyecto.Id)
            {
                return NotFound();
