...
namespace TFI_ADM_RECURSOS_2023.Data.Migrations
{
    ...
    [Migration("20231027182335_datetime_cliente4")]
    partial class datetime_cliente4
    {
            ...
            modelBuilder.Entity("TFI_ADM_RECURSOS_2023.Models.Factura", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            fechaEmision = new DateTime(2023, 10, 27, 15, 23, 34, 903, DateTimeKind.Local).AddTicks(8720),
                            fechaVencimiento = new DateTime(2024, 3, 27, 15, 23, 34, 903, DateTimeKind.Local).AddTicks(8722),
                            total = 5000.0
                        });
                });
