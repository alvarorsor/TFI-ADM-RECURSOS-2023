...
namespace TFI_ADM_RECURSOS_2023.Data.Migrations
{
    ...
    [Migration("20231027182153_datetime_cliente3")]
    partial class datetime_cliente3
    {
            ...
            modelBuilder.Entity("TFI_ADM_RECURSOS_2023.Models.Factura", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            fechaEmision = new DateTime(2023, 10, 27, 15, 21, 52, 347, DateTimeKind.Local).AddTicks(6934),
                            fechaVencimiento = new DateTime(2024, 3, 27, 15, 21, 52, 347, DateTimeKind.Local).AddTicks(6935),
                            total = 5000.0
                        });
                });
