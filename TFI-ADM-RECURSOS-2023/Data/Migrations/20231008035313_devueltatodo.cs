...
{
    public partial class devueltatodo : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "23-39572450-9", "perez", "av alem 330", "juanperez@gmail.com", new DateTime(2023, 10, 8, 0, 53, 13, 192, DateTimeKind.Local).AddTicks(3166), "Juan", 1234567 });

            migrationBuilder.InsertData(
                table: "Clientes",
                columns: new[] { "Id", "CUIT", "apellido", "direccion", "email", "fecha_alta", "nombre", "telefono" },
                values: new object[] { 2, "23-39572450-9", "perez", "av alem 330", "juanperez@gmail.com", new DateTime(2023, 10, 8, 0, 53, 13, 192, DateTimeKind.Local).AddTicks(3179), "Juan", 1234567 });
            ...
            migrationBuilder.InsertData(
                table: "Facturas",
                columns: new[] { "Id", "ClienteId", "condicionTributaria", "fechaEmision", "fechaVencimiento", "total" },
                values: new object[] { 1, 1, "Responsable inscripto", new DateTime(2023, 10, 8, 0, 53, 13, 192, DateTimeKind.Local).AddTicks(3202), new DateTime(2024, 3, 8, 0, 53, 13, 192, DateTimeKind.Local).AddTicks(3203), 5000.0 });
